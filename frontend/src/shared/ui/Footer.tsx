                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-12 lg:gap-8 mb-16">
                    ...
                    <div className="lg:col-span-2 lg:col-start-6">
                        ...
                        <ul className="space-y-3">
                            ...
                            <li><Link href={`/sign-up/mentor?redirect=${encodeURIComponent(typeof window !== 'undefined' ? window.location.pathname === '/' ? '/' : window.location.pathname : '/')}`} className="text-sm text-gray-500 hover:text-blue-600 transition-colors">Become a Mentor</Link></li>
                        </ul>
                    </div>
